...
{
    protected $fillable   = [ 'sName', 'iType', 'iBusinessType', 'iGroup', 'iDisplay', 'iParentID', 'iLevel', 'sRelation',
    ...
    protected $orderable  = ['*'];
    protected $rangeable  = ['*'];
    protected $columnable = [ 'iAutoID', 'sName', 'iType', 'iBusinessType', 'iGroup', 'iDisplay', 'iParentID', 'iLevel', 'sRelation',
        'sAndroidPath', 'sIosPath', 'sH5Path', 'sWebPath', 'sParam', 'iJumpType', 'sRealUrl', 'iLeaf', 'iShow',
        'sIcon', 'iOrder', 'iHome', 'iCreateTime', 'iUpdateTime', 'iDeleteTime', 'iStatus'];
