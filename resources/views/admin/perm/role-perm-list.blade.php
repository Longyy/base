...
@section('after-js')
    ...
    <script>
        var $ok = $('#ok');
        var $table = $('#table');
        var tableListUrl = "/backend/perm/role_perm/get_list";
        var tableEditUrl = "/backend/perm/role_perm/edit";
        var tableDelUrl = "/backend/perm/role_perm/delete";
        var tableNewUrl = "/backend/perm/role_perm/create";
        var tableColumns = [
            {
                field: "state",
                checkbox: true
