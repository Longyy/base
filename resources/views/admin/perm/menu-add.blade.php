                        ...
                        <div class="panel-body">
                            <div class="form-horizontal edit-form-width">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sWebPath" value="" required class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sParam" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iJumpType" checked value="1">
                                                <i class="fa fa-circle-o"></i> 内页 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iJumpType" value="2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sRealUrl" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iLeaf" checked value="1">
                                                <i class="fa fa-circle-o"></i> 否 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iLeaf" value="2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iShow" checked value="1">
                                                <i class="fa fa-circle-o"></i> 否 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iShow" value="2">
                                                <i class="fa fa-circle-o"></i> 是 </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iDisplay" checked value="1">
                                                <i class="fa fa-circle-o"></i> 否 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iDisplay" value="2">
                                                <i class="fa fa-circle-o"></i> 是 </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sIcon" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="iOrder" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iHome" checked value="1">
                                                <i class="fa fa-circle-o"></i> 否 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iHome" value="2">
                                                <i class="fa fa-circle-o"></i> 是 </label>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function getMenuTree()
        {
            ...
            if(iType > 0 && iBusinessType > 0) {
                $.getJSON('/backend/perm/menu/get_menu_tree?iType=' + iType + '&iBusinessType=' + iBusinessType, function(res) {
                    if(res.code == 0) {
                        $('#menu-tree').treeview({
                            levels: 1,
                            color: "#428bca",
