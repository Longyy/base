...
@section('after-js')
    ...
    <script>
        var $ok = $('#ok');
        var $table = $('#table');
        var tableListUrl = "/backend/perm/resource/get_list";
        var tableEditUrl = "/backend/perm/resource/edit";
        var tableDelUrl = "/backend/perm/resource/delete";
        var tableNewUrl = "/backend/perm/resource/create";
        var tableColumns = [
            {
                field: "state",
                checkbox: true
