...
@section('after-js')
    ...
    <script>
        var $ok = $('#ok');
        var $table = $('#table');
        var tableListUrl = "/backend/perm/role/get_list";
        var tableEditUrl = "/backend/perm/role/edit";
        var tableDelUrl = "/backend/perm/role/delete";
        var tableNewUrl = "/backend/perm/role/create";
        var tableColumns = [
            {
                field: "state",
                checkbox: true
