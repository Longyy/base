                    ...
                    <div class="panel-body">
                        <div class="form-horizontal edit-form-width">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sName" value="{{$data['role_perm']['sRoleName']}}" required class="form-control" placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sName" value="{{$data['role_perm']['sName']}}" required class="form-control" placeholder="">
                                </div>
                            </div>
