                        ...
                        <div class="panel-body">
                            <div class="form-horizontal edit-form-width">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sControllerName" value="" required class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sFunctionName" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sPath" value="" class="form-control" placeholder="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iShow" value="1">
...
@section('after-js')
    ...
    <script>
        ...
        function submitData()
        {
            ...
            $.ajax({
                type: 'POST',
                url: '/backend/perm/resource/save',
                cache: false,
                async: false,
                dataType: 'json',
                data: data,
