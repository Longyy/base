        ...
        <section class="vbox">
            ...
            <section class="scrollable wrapper">
                ...
                <form id="form"  data-parsley-validate>
                    ...
                    <input type="hidden" name="iAutoID" value="{{$data['resource']['iAutoID']}}"/>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal edit-form-width">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sName" value="{{$data['resource']['sName']}}" required class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">类型</label>
                                    <div class="col-sm-9">
                                        <select name="iType" id="iType" required class="form-control m-t">
                                            <option value="">--请选择--</option>
                                            @foreach($data['resource_type'] as $key => $val)
                                                <option value="{{$key}}" @if($key == $data['resource']['iType'])selected @endif>{{$val}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="iBusinessType" id="iBusinessType" required class="form-control m-t">
                                            <option value="">--请选择--</option>
                                            @foreach($data['resource_business_type'] as $key => $val)
                                                <option value="{{$key}}" @if($key == $data['resource']['iBusinessType'])selected @endif>{{$val}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="sControllerName" value="{{$data['resource']['sControllerName']}}" required class="form-control" placeholder="">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Function名</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="sFunctionName" value="{{$data['resource']['sFunctionName']}}" class="form-control" placeholder="">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label">相对路径名称</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="sPath" value="{{$data['resource']['sPath']}}" class="form-control" placeholder="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iShow" @if($data['resource']['iShow'] == 1) checked @endif value="1">
                                                <i class="fa fa-circle-o"></i> 否 </label>
                                        </div>
                                        <div class="radio">
                                            <label class="radio-custom">
                                                <input type="radio" name="iShow" @if($data['resource']['iShow'] == 2) checked @endif value="2">
    ...
    <script>
        ...
        function submitData()
        {
            ...
            var data = {
                ...
                sControllerName: $form.find("input[name='sControllerName']").val(),
                sFunctionName: $form.find("input[name='sFunctionName']").val(),
                sPath: $form.find("input[name='sPath']").val(),
                iShow: $form.find("radio[name='iShow']:checked").val()
            };
            var resultInfo = {};
            $.ajax({
                type: 'POST',
                url: '/backend/perm/resource/update',
                cache: false,
                async: false,
                dataType: 'json',
                data: data,
